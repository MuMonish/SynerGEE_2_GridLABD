...
function Make_OH_Line_Configuration=making_OH_Line_Configuration(dir_name,FeederName,glm_dir_name)
...
[conf_OH_name_unique row_index col_index]= unique(conf_OH_name);
